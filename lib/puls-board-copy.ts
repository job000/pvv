...
export const pulsBoardCopy = {
  ...
  createHint: "Skriv en tittel for å komme i gang.",
  createHintSub: "Blir et eget kort under valgt forelder.",
  createInColumn: (name: string) => `I ${name}`,
  createAddDescription: "Legg til beskrivelse",
  createHideDescription: "Skjul beskrivelse",
  createLinkLabel: "Koblinger",
  createLinkHint: "Valgfritt — vurdering, prosess, ROS, PDD og/eller skjema.",
  createLinkShow: "Koblinger",
  ...
  createSubmit: "Opprett",
  createSubmitting: "Oppretter …",
